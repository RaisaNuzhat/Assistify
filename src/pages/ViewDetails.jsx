        ...
        <div className="mx-auto container flex flex-col justify-center font-Roboto">
            ...
            <section>
                <div className="dark:bg-violet-600 bg-[#ddeedf]">
                    <div className="container flex flex-col items-center px-4 py-16 pb-24 mx-auto text-center lg:pb-56 md:py-32 md:px-10 lg:px-32 dark:text-gray-50">
                        ...
                        <div className="flex flex-wrap justify-center">
                            <Link to={`/beavolunteer/${_id}`}type="button" className="px-8 py-3 m-2 text-lg font-semibold rounded dark:bg-gray-100 bg-[#5c715e] text-white dark:text-gray-900">Be A Volunteer</Link>
                ...
                <div className="container mx-auto my-4 flex flex-col justify-center items-center text-center font-Montserrat">
                    ...
                    <p className="my-3   lg:text-xl text-[16px] sm:mb-12 xl:max-w-3xl dark:text-gray-50">Deadline: {new Date(deadline).toLocaleDateString()}</p>
